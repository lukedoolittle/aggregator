...
## Packages
You can get Quantfabric.Material by grabbing the latest [NuGet package](#https://www.nuget.org/packages/Quantfabric.Material/). Currently supported on .NET 4.5.2, Xamarin.Android, Xamarin.iOS, Windows UWP, and Xamarin.Forms
