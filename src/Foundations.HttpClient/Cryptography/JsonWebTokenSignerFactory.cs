            ...
            where TAlgorithm : class
        {
            switch (algorithm)
            {
                ...
                case JsonWebTokenAlgorithm.ES256:
                    return new SigningAlgorithm(SignerUtilities.GetSigner("SHA-256withECDSA")) as TAlgorithm;
                case JsonWebTokenAlgorithm.ES384:
                    return new SigningAlgorithm(SignerUtilities.GetSigner("SHA-384withECDSA")) as TAlgorithm;
                case JsonWebTokenAlgorithm.ES512:
                    return new SigningAlgorithm(SignerUtilities.GetSigner("SHA-512withECDSA")) as TAlgorithm;
