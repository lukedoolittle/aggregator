...
namespace Aggregator.Infrastructure.Clients
{
    ...
    {
        public WithingsWeighinOAuthClient(IOAuthProtectedResource oauthRequest) :
            base(oauthRequest)
        {
        }

        //TODO: uncomment this when we have implemented the timeseries, filterable interfaces
