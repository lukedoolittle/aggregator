    ...
    public class FullWorkflowFixture
    {
        ...
        public async void BootstrapAndRunStopSchedulerAndAddNewServiceThenResumeRunning()
        {
            ...
            using (var helper = new WorkflowFixture())
            {
                ...
                helper.User.CreateSensor<GoogleGmail, Google>(PollingIntervalEnum.Moderate);
        ...
        public async void BootstrapWithNoRunValidateAServiceAndThenRevalidateExpectedAnUpdatedToken()
        {
            using (var helper = new WorkflowFixture())
            {
                ...
                helper.User.CreateSensor<FacebookFeed, Facebook>(PollingIntervalEnum.Moderate);
        ...
        public async void BootstrapAndRunValidateServiceAndThenDeactivateAndReactivateSensor()
        {
            ...
            using (var helper = new WorkflowFixture())
            {
                ...
                user.CreateSensor<TwitterTweet, Twitter>(PollingIntervalEnum.Moderate);
        ...
        //        helper.User.CreateSensor<RescuetimeAnalyticData, Rescuetime>(PollingIntervalEnum.Moderate);
        //        await helper.User.CreateToken<Fitbit>();
        //        helper.User.CreateSensor<FitbitIntradaySteps, Fitbit>(PollingIntervalEnum.Moderate);
        //        helper.User.CreateSensor<FitbitSleep, Fitbit>(PollingIntervalEnum.Moderate);
