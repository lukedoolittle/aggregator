...
{
	[Aggregator.Framework.Metadata.ClientType(typeof(Aggregator.Infrastructure.Clients.OAuthClient<TwitterFavorite>))]        
	...
	public partial class TwitterFavorite : OAuthRequest
	{
		...
		public override String SinglePath => "/1.1/favorites/list.json";
