...
{
	[Aggregator.Framework.Metadata.ClientType(typeof(Aggregator.Infrastructure.Clients.OAuthClient<TwitterTimeline>))]        
	...
	public partial class TwitterTimeline : OAuthRequest
	{
		...
		public override String SinglePath => "/1.1/statuses/home_timeline.json";
