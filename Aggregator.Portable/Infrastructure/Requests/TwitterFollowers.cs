...
{
	[Aggregator.Framework.Metadata.ClientType(typeof(Aggregator.Infrastructure.Clients.OAuthClient<TwitterFollowers>))]        
	[Aggregator.Framework.Metadata.ServiceType(typeof(Aggregator.Infrastructure.Services.Twitter))]        
	public partial class TwitterFollowers : OAuthRequest
	{
			public override String Host => "https://api.twitter.com/";
		public override String SinglePath => "/1.1/followers/list.json";
