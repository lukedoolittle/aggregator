...
{
	[Aggregator.Framework.Metadata.ClientType(typeof(Aggregator.Infrastructure.Clients.OAuthClient<TwitterReceivedDirectMessage>))]        
	...
	public partial class TwitterReceivedDirectMessage : OAuthRequest
	{
		...
		public override String SinglePath => "/1.1/direct_messages.json";
