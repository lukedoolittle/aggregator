...
{
	[Aggregator.Framework.Metadata.ClientType(typeof(Aggregator.Infrastructure.Clients.TwitterIdOAuthClient))]        
	...
	public partial class TwitterTweet : OAuthRequest
	{
		...
		public override String SinglePath => "1.1/statuses/user_timeline.json";
