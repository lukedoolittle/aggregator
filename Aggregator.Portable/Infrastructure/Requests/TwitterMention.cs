...
{
	[Aggregator.Framework.Metadata.ClientType(typeof(Aggregator.Infrastructure.Clients.OAuthClient<TwitterMention>))]        
	...
	public partial class TwitterMention : OAuthRequest
	{
		...
		public override String SinglePath => "/1.1/statuses/mentions_timeline.json";
