...
{
	[Aggregator.Framework.Metadata.ClientType(typeof(Aggregator.Infrastructure.Clients.OAuthClient<TwitterRetweetOfMe>))]        
	...
	public partial class TwitterRetweetOfMe : OAuthRequest
	{
		...
		public override String SinglePath => "/1.1/statuses/retweets_of_me.json";
