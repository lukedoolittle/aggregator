...
namespace Aggregator.Infrastructure.Clients
{
    public class GoogleGmailRecursiveOAuthClient : OAuthClient<GoogleGmail>
    {
        ...
        public GoogleGmailRecursiveOAuthClient(
            IOAuth oauthRequest,
            OAuthClient<GoogleGmailMetadata> metadataRequest) :
            base(oauthRequest)
        {
            _metadataRequest = metadataRequest;
        }
            ...
            string recencyValue)
        {
            ...
            foreach (var message in messages)
            {
                ...
                recursiveRequest.AdditionalUrlSegmentParameters[GoogleGmail.MessageId] = 
                        message[GoogleGmailMetadata.Id].ToString();
            ...
            return recursiveRequests.Select(messageTask =>
            {
                ...
                {
                    //TODO: magic strings
                    messageResult[GoogleGmail.Body] = 
